...
var PHYS = {
  ...
  OFF_TRACK_GRIP: 0.56,
  OFF_TRACK_MAX_SPEED_FACTOR: 0.6,
...
function buildRaceViewModel(screen, game, weatherKey, aiDifficulty, lang, t) {
  ...
  const message = startOverlay.phase !== "off" ? startOverlay.detail : playerCar?.finished ? t.finishMessage : playerCar?.offTrack ? t.trackLimits : playerCar?.slipAngle > 0.13 && playerCar?.speed > 170 ? t.balanceCaution : game.trackDef.note[lang];
  return {
    mode: "race2dpro",
    coordinates: "origin_top_left_x_right_y_down",
    screen,
...
function parkCarsOnFinish(track, orderedCars) {
  const finishPoint = sampleTrackAt(track, track.startS + 2e-3);
...
function RaceGame2DPro() {
  ...
  const [weatherKey, setWeatherKey] = (0, import_react2.useState)("dry");
  ...
  if (screen === "setup") {
    return /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__setup" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__setupCard" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__setupHeader" }, /* @__PURE__ */ import_react2.default.createElement("div", null, /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__setupTitle" }, "GRID | ", t.title), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__setupSub" }, t.subtitle))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__setupDivider" }), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__sectionLabel" }, t.selectTrack), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__trackGrid" }, RACE2DPRO_CIRCUITS.map((track) => /* @__PURE__ */ import_react2.default.createElement(
      "div",
      {
        key: track.id,
    ...
    ))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__selectedTrack" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__selectedTrackTitle" }, viewModel.track.name), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__selectedTrackFacts" }, /* @__PURE__ */ import_react2.default.createElement("span", null, t.distanceLabel, ": ", viewModel.track.distanceKm), /* @__PURE__ */ import_react2.default.createElement("span", null, t.turnsLabel, ": ", viewModel.track.turns), /* @__PURE__ */ import_react2.default.createElement("span", null, t.overtakingLabel, ": ", viewModel.track.overtaking), /* @__PURE__ */ import_react2.default.createElement("span", null, t.profileLabel, ": ", viewModel.track.profile)), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__trackNote" }, viewModel.track.note), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__formatRow" }, /* @__PURE__ */ import_react2.default.createElement("span", { className: "r2p__formatChip" }, t.standingStart), /* @__PURE__ */ import_react2.default.createElement("span", { className: "r2p__formatChip" }, t.fiveLights), /* @__PURE__ */ import_react2.default.createElement("span", { className: "r2p__formatChip" }, t.staggeredGrid))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__optionsRow" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__optBlock" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__sectionLabel" }, t.selectWeather), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__choiceGroup" }, Object.entries(WEATHER_PROFILES).map(([key, weather]) => /* @__PURE__ */ import_react2.default.createElement(
      "button",
      {
        key,
        type: "button",
      ...
      " ",
      weather.label[lang]
    )))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__optBlock" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__sectionLabel" }, t.selectDifficulty), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__choiceGroup" }, ["easy", "medium", "hard"].map((difficulty) => /* @__PURE__ */ import_react2.default.createElement(
      "button",
      {
        key: difficulty,
        type: "button",
      ...
      count
    )))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__optBlock" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__sectionLabel" }, t.rivals), /* @__PURE__ */ import_react2.default.createElement("div", { className: "r2p__choiceGroup" }, [3, 5, 7].map((count) => /* @__PURE__ */ import_react2.default.createElement(
      "button",
      {
        key: count,
        type: "button",
