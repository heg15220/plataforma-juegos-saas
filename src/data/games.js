...
export const games = [
...

  {
    ...
    category: "Estrategia",
    tagline: "Mesa de baraja con modalidades Brisca/Tute y Mus (clasico + adaptacion inglesa).",
    description:
      "Juego de cartas estrategico con selector de modalidad: Brisca/Tute mantiene el motor de bazas original y Mus anade un modo configurable a 40 piedras con 2, 4 o 6 jugadores (duelo, parejas o 3v3), incluyendo version adaptada para baraja inglesa.",
    objective_es: "Elige modalidad: en Brisca/Tute gana bazas; en Mus alcanza 40 piedras antes del campo rival con mesa 2/4/6.",
    howToPlay_es: "Usa el selector superior para cambiar de modalidad y configurar 2, 4 o 6 jugadores en Mus. Brisca/Tute: click o teclas 1-3 para jugar carta. Mus: M/X para Mus-No Mus, 1-4 para descarte, Enter confirma, N siguiente mano y R reinicia.",
    highlights: [
      "Modalidad dual en un mismo juego: Brisca/Tute + Mus.",
    ...
    difficulty: "Media",
    multiplayer: "Solo vs IA",
    viability: "Alta: estado compacto en dos motores (bazas y lances de Mus) con reglas discretas.",
    visualStyle: "Mesa de cartas tactica con selector de modalidad y paneles de estado por modo.",
    techFocus: "Convivencia de motor Brisca/Tute existente con motor Mus (lances, descarte y tanteo a 40 piedras), incluyendo adaptacion inglesa.",

    category_en: "Strategy",
    tagline_en: "Card table with Brisca/Tute and Mus modes (classic + adapted English variant).",
    description_en:
      "Card strategy game with a top mode switch: Brisca/Tute keeps the original trick-taking engine while Mus adds a configurable race to 40 stones with 2, 4, or 6 players (including an adapted English-deck variant).",
    objective_en: "Choose mode: win tricks in Brisca/Tute or reach 40 stones first in Mus with 2/4/6 table setups.",
    howToPlay_en: "Use the top switch to change mode and set 2, 4, or 6 players in Mus. Brisca/Tute: click or keys 1-3 to play cards. Mus: M/X for Mus-No Mus, 1-4 for discard, Enter confirms, N next hand, R restart.",
    highlights_en: [
      "Dual mode in one game: Brisca/Tute + Mus.",
    ...
    difficulty_en: "Medium",
    multiplayer_en: "Solo vs AI",
    viability_en: "High: compact state across two discrete engines (tricks + Mus lances).",
    visualStyle_en: "Tactical card table with top mode switch and mode-specific status panels.",
    techFocus_en: "Coexistence of existing Brisca/Tute engine with new Mus engine (discard, lances, race to 40 stones), including adapted English mode.",
  },
