...
const CONTROL_HINTS_BY_LOCALE = {
  es: {
    ...
    "arcade-billar-pool-club": "Mueve el raton para apuntar, A/D afinan el angulo, W/S regulan potencia, Space tira, clic coloca la blanca en mano y F activa pantalla completa.",
  ...
  en: {
    ...
    "arcade-billar-pool-club": "Move the mouse to aim, A/D fine tune the cue, W/S adjust power, Space shoots, click to place cue ball in hand, and F toggles fullscreen.",
